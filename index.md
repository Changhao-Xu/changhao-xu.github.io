...
My research interests are in the intersections of **machine learning**, **wearable electronic skin**, **robotics** and **personalized health**, spanning the spectrum from wearable sensors development, algorithm design, to applications in robotics and medicine. To that end, my research has three goals: **(1) develop robust sensors for continuous long-term monitoring; (2) bridge sensing data stream with robotics and health through an autonomous machine learning pipeline; and (3) advance robotics and health assessment with intelligent systems.**
